...
Repositories (adjust if your layout differs; set env vars or use [reference.md](../skills/zetasql-stack-upgrade/reference.md)):
...
- Command templates and paths: [reference.md](../skills/zetasql-stack-upgrade/reference.md)
