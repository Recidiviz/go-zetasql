...
- **go-googlesqlite:** Sync **FunctionSignatureId** / builtin registration and `function_bind.go` for new builtins you choose to support; **TypeKind** additions may require type mapping if exposed. Add **query tests** for any newly implemented behavior.
