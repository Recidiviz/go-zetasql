...
| 2 | **Abseil** | Optional second archive if duplicate `absl` objects must leave per-package TUs; align with `cclib.global_exclude_replace_names` in [`internal/cmd/generator/config.yaml`](../internal/cmd/generator/config.yaml). |
