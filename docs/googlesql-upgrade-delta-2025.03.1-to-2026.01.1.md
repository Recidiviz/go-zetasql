...
This note tracks **upstream** changes between tags `2025.03.1` and `2026.01.1` in [google/zetasql](https://github.com/google/zetasql) and how **go-googlesql**, **go-googlesqlite**, and **bigquery-emulator** align.
...
Sequential: **`make local/test`** (go-googlesql) → **`go test -tags googlesql -p 1`** (zetasqlite) → **emulator** last.
