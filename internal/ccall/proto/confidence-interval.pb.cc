...
const ::uint32_t TableStruct_proto_2fconfidence_2dinterval_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_proto_2fconfidence_2dinterval_2eproto = {
    ...
    file_level_metadata_proto_2fconfidence_2dinterval_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto_2fconfidence_2dinterval_2eproto(&descriptor_table_proto_2fconfidence_2dinterval_2eproto);
namespace differential_privacy {
// ===================================================================
...
::uint8_t* ConfidenceInterval::_InternalSerialize(
  ...
  if (raw_upper_bound != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(
        1, this->_internal_upper_bound(), target);
  }
  ...
  if (raw_lower_bound != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(
        2, this->_internal_lower_bound(), target);
  }
