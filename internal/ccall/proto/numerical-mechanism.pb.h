...
class GaussianMechanism final :
 ...
 public:
  ...
  explicit constexpr GaussianMechanism(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class LaplaceMechanism final :
 ...
 public:
  ...
  explicit constexpr LaplaceMechanism(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
