...
PROTOBUF_NAMESPACE_OPEN
template<> ::zetasql::ColumnRefProto* Arena::CreateMaybeMessage<::zetasql::ColumnRefProto>(Arena*);
...
class ResolvedColumnProto final :
 ...
 public:
  ...
  explicit constexpr ResolvedColumnProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ValueWithTypeProto final :
 ...
 public:
  ...
  explicit constexpr ValueWithTypeProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TableRefProto final :
 ...
 public:
  ...
  explicit constexpr TableRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ModelRefProto final :
 ...
 public:
  ...
  explicit constexpr ModelRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ConnectionRefProto final :
 ...
 public:
  ...
  explicit constexpr ConnectionRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ConstantRefProto final :
 ...
 public:
  ...
  explicit constexpr ConstantRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class FunctionRefProto final :
 ...
 public:
  ...
  explicit constexpr FunctionRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TableValuedFunctionRefProto final :
 ...
 public:
  ...
  explicit constexpr TableValuedFunctionRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ResolvedNodeProto final :
 ...
 public:
  ...
  explicit constexpr ResolvedNodeProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class FieldDescriptorRefProto final :
 ...
 public:
  ...
  explicit constexpr FieldDescriptorRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class OneofDescriptorRefProto final :
 ...
 public:
  ...
  explicit constexpr OneofDescriptorRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ProcedureRefProto final :
 ...
 public:
  ...
  explicit constexpr ProcedureRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ResolvedCollationProto final :
 ...
 public:
  ...
  explicit constexpr ResolvedCollationProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ColumnRefProto final :
 ...
 public:
  ...
  explicit constexpr ColumnRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  private:
  bool _internal_has_table_ref() const;
  public:
...
inline bool ResolvedNodeProto::_internal_has_parse_location_range() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || parse_location_range_ != nullptr);
  return value;
}
...
inline void ResolvedNodeProto::unsafe_arena_set_allocated_parse_location_range(
    ::zetasql::ParseLocationRangeProto* parse_location_range) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(parse_location_range_);
  }
...
inline ::zetasql::ParseLocationRangeProto* ResolvedNodeProto::_internal_mutable_parse_location_range() {
  _has_bits_[0] |= 0x00000001u;
  if (parse_location_range_ == nullptr) {
...
inline bool FieldDescriptorRefProto::_internal_has_containing_proto() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || containing_proto_ != nullptr);
  return value;
}
...
inline void FieldDescriptorRefProto::unsafe_arena_set_allocated_containing_proto(
    ::zetasql::ProtoTypeProto* containing_proto) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(containing_proto_);
  }
...
void ResolvedCollationProto::set_collation_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 collation_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ResolvedCollationProto::_internal_set_collation_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  collation_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ResolvedCollationProto::_internal_mutable_collation_name() {
  _has_bits_[0] |= 0x00000001u;
  return collation_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ResolvedCollationProto::release_collation_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = collation_name_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (collation_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void ResolvedCollationProto::set_allocated_collation_name(std::string* collation_name) {
  ...
  collation_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), collation_name,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (collation_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    collation_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
...
// optional .zetasql.TableRefProto table_ref = 1;
inline bool ColumnRefProto::_internal_has_table_ref() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || table_ref_ != nullptr);
  return value;
}
inline bool ColumnRefProto::has_table_ref() const {
  return _internal_has_table_ref();
}
inline void ColumnRefProto::clear_table_ref() {
  if (table_ref_ != nullptr) table_ref_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::zetasql::TableRefProto& ColumnRefProto::_internal_table_ref() const {
  const ::zetasql::TableRefProto* p = table_ref_;
...
inline void ColumnRefProto::unsafe_arena_set_allocated_table_ref(
    ::zetasql::TableRefProto* table_ref) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(table_ref_);
  }
...
inline ::zetasql::TableRefProto* ColumnRefProto::release_table_ref() {
  _has_bits_[0] &= ~0x00000002u;
  ::zetasql::TableRefProto* temp = table_ref_;
  table_ref_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline void ColumnRefProto::set_allocated_table_ref(::zetasql::TableRefProto* table_ref) {
  ...
  if (table_ref) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::zetasql::TableRefProto>::GetOwningArena(table_ref);
    if (message_arena != submessage_arena) {
...
// optional string name = 2;
inline bool ColumnRefProto::_internal_has_name() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ColumnRefProto::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ColumnRefProto::set_allocated_name(std::string* name) {
  if (name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
