...
constexpr ResolvedASTRewrite ResolvedASTRewrite_MAX = REWRITE_INLINE_SQL_VIEWS;
...
class LanguageFeatureOptions final :
 ...
 public:
  ...
  explicit constexpr LanguageFeatureOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ResolvedASTRewriteOptions final :
 ...
 public:
  ...
  explicit constexpr ResolvedASTRewriteOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
