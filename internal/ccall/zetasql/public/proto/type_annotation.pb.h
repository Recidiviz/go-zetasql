...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fproto_2ftype_5fannotation_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fproto_2ftype_5fannotation_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::zetasql::DeprecatedEncoding* Arena::CreateMaybeMessage<::zetasql::DeprecatedEncoding>(Arena*);
template <>
::zetasql::FieldFormat* Arena::CreateMaybeMessage<::zetasql::FieldFormat>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
template <>
struct is_proto_enum<::zetasql::FieldFormat_Format> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::zetasql::FieldFormat_Format>() {
  return ::zetasql::FieldFormat_Format_descriptor();
}
template <>
struct is_proto_enum<::zetasql::DeprecatedEncoding_Encoding> : std::true_type {};
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fproto_2ftype_5fannotation_2eproto_2epb_2eh
