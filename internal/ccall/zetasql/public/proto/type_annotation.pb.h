...
class FieldFormat final :
 ...
 public:
  ...
  explicit constexpr FieldFormat(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class DeprecatedEncoding final :
 ...
 public:
  ...
  explicit constexpr DeprecatedEncoding(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
