...
class SimpleAnonymizationInfoProto final :
 ...
 public:
  ...
  explicit constexpr SimpleAnonymizationInfoProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SimpleTableProto final :
 ...
 public:
  ...
  explicit constexpr SimpleTableProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SimpleColumnProto final :
 ...
 public:
  ...
  explicit constexpr SimpleColumnProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void SimpleTableProto::set_name_in_catalog(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 name_in_catalog_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& SimpleTableProto::_internal_name_in_catalog() const {
  return name_in_catalog_.Get();
}
inline void SimpleTableProto::_internal_set_name_in_catalog(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  name_in_catalog_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SimpleTableProto::_internal_mutable_name_in_catalog() {
  _has_bits_[0] |= 0x00000002u;
  return name_in_catalog_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SimpleTableProto::release_name_in_catalog() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = name_in_catalog_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (name_in_catalog_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void SimpleTableProto::set_allocated_name_in_catalog(std::string* name_in_catalog) {
  ...
  name_in_catalog_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name_in_catalog,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (name_in_catalog_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    name_in_catalog_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
...
inline void SimpleTableProto::set_allocated_anonymization_info(::zetasql::SimpleAnonymizationInfoProto* anonymization_info) {
  ...
  if (anonymization_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::zetasql::SimpleAnonymizationInfoProto>::GetOwningArena(anonymization_info);
