...
class DeprecationWarning final :
 ...
 public:
  ...
  explicit constexpr DeprecationWarning(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class FreestandingDeprecationWarning final :
 ...
 public:
  ...
  explicit constexpr FreestandingDeprecationWarning(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void FreestandingDeprecationWarning::set_caret_string(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 caret_string_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& FreestandingDeprecationWarning::_internal_caret_string() const {
  return caret_string_.Get();
}
inline void FreestandingDeprecationWarning::_internal_set_caret_string(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  caret_string_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* FreestandingDeprecationWarning::_internal_mutable_caret_string() {
  _has_bits_[0] |= 0x00000002u;
  return caret_string_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* FreestandingDeprecationWarning::release_caret_string() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = caret_string_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (caret_string_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void FreestandingDeprecationWarning::set_allocated_caret_string(std::string* caret_string) {
  ...
  caret_string_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), caret_string,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (caret_string_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    caret_string_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
...
inline bool FreestandingDeprecationWarning::_internal_has_error_location() const {
  ...
  PROTOBUF_ASSUME(!value || error_location_ != nullptr);
  return value;
}
...
inline void FreestandingDeprecationWarning::unsafe_arena_set_allocated_error_location(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(error_location_);
  }
...
inline bool FreestandingDeprecationWarning::_internal_has_deprecation_warning() const {
  ...
  PROTOBUF_ASSUME(!value || deprecation_warning_ != nullptr);
  return value;
}
...
inline void FreestandingDeprecationWarning::clear_deprecation_warning() {
  if (deprecation_warning_ != nullptr) deprecation_warning_->Clear();
...
inline void FreestandingDeprecationWarning::unsafe_arena_set_allocated_deprecation_warning(
    ::zetasql::DeprecationWarning* deprecation_warning) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(deprecation_warning_);
  }
...
inline ::zetasql::DeprecationWarning* FreestandingDeprecationWarning::_internal_mutable_deprecation_warning() {
  _has_bits_[0] |= 0x00000008u;
  if (deprecation_warning_ == nullptr) {
...
inline void FreestandingDeprecationWarning::set_allocated_deprecation_warning(::zetasql::DeprecationWarning* deprecation_warning) {
  ...
  if (deprecation_warning) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::zetasql::DeprecationWarning>::GetOwningArena(deprecation_warning);
    if (message_arena != submessage_arena) {
