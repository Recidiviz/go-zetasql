...
enum FunctionSignatureId : int {
  ...
  FN_RANGE_IS_START_UNBOUNDED_INT64 = 2901,
  FN_RANGE_IS_END_UNBOUNDED = 2902,
  FN_RANGE_IS_END_UNBOUNDED_INT64 = 2903,
  FN_RANGE_START = 2904,
  FN_RANGE_START_INT64 = 2905,
  FN_RANGE_END = 2906,
  FN_RANGE_END_INT64 = 2907,
  FN_RANGE_OVERLAPS = 2908,
  FN_RANGE_OVERLAPS_LEFT_INT64 = 2909,
  FN_RANGE_OVERLAPS_RIGHT_INT64 = 2910,
  FN_RANGE_OVERLAPS_BOTH_INT64 = 2911,
  FN_RANGE_INTERSECT = 2912,
  FN_RANGE_INTERSECT_LEFT_INT64 = 2913,
  FN_RANGE_INTERSECT_RIGHT_INT64 = 2914,
  FN_RANGE_INTERSECT_BOTH_INT64 = 2915
};
...
constexpr FunctionSignatureId FunctionSignatureId_MAX = FN_RANGE_INTERSECT_BOTH_INT64;
