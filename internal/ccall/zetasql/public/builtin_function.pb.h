...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto_2epb_2eh
...
enum FunctionSignatureId : int {
  ...
  FN_APPROX_COSINE_DISTANCE_DOUBLE_WITH_OPTIONS = 2357,
  FN_APPROX_COSINE_DISTANCE_FLOAT_WITH_OPTIONS = 2358,
  ...
  FN_APPROX_EUCLIDEAN_DISTANCE_DOUBLE_WITH_OPTIONS = 2361,
  FN_APPROX_EUCLIDEAN_DISTANCE_FLOAT_WITH_OPTIONS = 2362,
  ...
  FN_APPROX_DOT_PRODUCT_INT64_WITH_OPTIONS = 2369,
  FN_APPROX_DOT_PRODUCT_FLOAT_WITH_OPTIONS = 2370,
  FN_APPROX_DOT_PRODUCT_DOUBLE_WITH_OPTIONS = 2371,
...
constexpr FunctionSignatureId FunctionSignatureId_MAX = static_cast<FunctionSignatureId>(3000);
constexpr int FunctionSignatureId_ARRAYSIZE = 3000 + 1;
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
FunctionSignatureId_descriptor();
template <typename T>
const std::string& FunctionSignatureId_Name(T value) {
  static_assert(std::is_same<T, FunctionSignatureId>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to FunctionSignatureId_Name().");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(FunctionSignatureId_descriptor(), value);
}
inline bool FunctionSignatureId_Parse(absl::string_view name, FunctionSignatureId* value) {
...
template <>
struct is_proto_enum<::zetasql::FunctionSignatureId> : std::true_type {};
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto_2epb_2eh
