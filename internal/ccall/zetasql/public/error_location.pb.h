...
class ErrorLocation final :
 ...
 public:
  ...
  explicit constexpr ErrorLocation(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ErrorSource final :
 ...
 public:
  ...
  explicit constexpr ErrorSource(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void ErrorSource::clear_error_message_caret_string() {
  error_message_caret_string_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000002u;
}
...
void ErrorSource::set_error_message_caret_string(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 error_message_caret_string_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& ErrorSource::_internal_error_message_caret_string() const {
  return error_message_caret_string_.Get();
}
inline void ErrorSource::_internal_set_error_message_caret_string(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  error_message_caret_string_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ErrorSource::_internal_mutable_error_message_caret_string() {
  _has_bits_[0] |= 0x00000002u;
  return error_message_caret_string_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ErrorSource::release_error_message_caret_string() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = error_message_caret_string_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (error_message_caret_string_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void ErrorSource::set_allocated_error_message_caret_string(std::string* error_message_caret_string) {
  ...
  error_message_caret_string_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), error_message_caret_string,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (error_message_caret_string_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    error_message_caret_string_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
...
inline void ErrorSource::set_allocated_error_location(::zetasql::ErrorLocation* error_location) {
  ...
  if (error_location) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::zetasql::ErrorLocation>::GetOwningArena(error_location);
