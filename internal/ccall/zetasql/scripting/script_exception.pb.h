...
class ScriptException_StackTraceFrame final :
 ...
 public:
  ...
  explicit constexpr ScriptException_StackTraceFrame(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ScriptException_Internal final :
 ...
 public:
  ...
  explicit constexpr ScriptException_Internal(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ScriptException final :
 ...
 public:
  ...
  explicit constexpr ScriptException(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline bool HasExtension(
      const ::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier<
          ScriptException, _proto_TypeTraits, _field_type, _is_packed>& id) const {
  ...
  inline void ClearExtension(
      const ::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier<
          ScriptException, _proto_TypeTraits, _field_type, _is_packed>& id) {
...
void ScriptException_Internal::set_statement_text(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 statement_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& ScriptException_Internal::_internal_statement_text() const {
  return statement_text_.Get();
}
inline void ScriptException_Internal::_internal_set_statement_text(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  statement_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ScriptException_Internal::_internal_mutable_statement_text() {
  _has_bits_[0] |= 0x00000001u;
  return statement_text_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ScriptException_Internal::release_statement_text() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = statement_text_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (statement_text_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void ScriptException_Internal::set_allocated_statement_text(std::string* statement_text) {
  ...
  statement_text_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), statement_text,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (statement_text_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    statement_text_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
...
inline void ScriptException::set_allocated_internal(::zetasql::ScriptException_Internal* internal) {
  ...
  if (internal) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::zetasql::ScriptException_Internal>::GetOwningArena(internal);
