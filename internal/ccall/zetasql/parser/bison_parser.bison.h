...
#line 325 "bazel-out/k8-fastbuild/bin/zetasql/parser/bison_parser.bison.h" // lalr1.cc:401
  ...
  public:
    ...
    union semantic_type
    {
    #line 378 "zetasql/parser/bison_parser.y" // lalr1.cc:401
...
#line 432 "bazel-out/k8-fastbuild/bin/zetasql/parser/bison_parser.bison.h" // lalr1.cc:401
    };
#else
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        KW_EXCEPTION = 559,
        KW_ERROR = 560,
        KW_CORRESPONDING = 561,
        KW_STRICT = 562,
        KW_INTERLEAVE = 563,
        KW_NULL_FILTERED = 564,
        KW_PARENT = 565,
        SENTINEL_NONRESERVED_KW_END = 566,
        KW_CURRENT_DATETIME_FUNCTION = 567,
        MACRO_BODY_TOKEN = 568,
        MODE_STATEMENT = 569,
        MODE_SCRIPT = 570,
        MODE_NEXT_STATEMENT = 571,
        MODE_NEXT_SCRIPT_STATEMENT = 572,
        MODE_NEXT_STATEMENT_KIND = 573,
        MODE_EXPRESSION = 574,
        MODE_TYPE = 575
      };
    };
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 33185,     ///< Last index in yytable_.
      yynnts_ = 578,  ///< Number of nonterminal symbols.
      yyfinal_ = 458, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
...
#line 1270 "bazel-out/k8-fastbuild/bin/zetasql/parser/bison_parser.bison.h" // lalr1.cc:401
