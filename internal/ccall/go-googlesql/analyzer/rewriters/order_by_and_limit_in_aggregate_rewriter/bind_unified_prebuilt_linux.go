...
package order_by_and_limit_in_aggregate_rewriter
...
#define GO_EXPORT(API) export_googlesql_analyzer_rewriters_order_by_and_limit_in_aggregate_rewriter_ ## API
#include "bridge.h"
#undef GO_EXPORT
