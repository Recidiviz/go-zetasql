...
#define googlesql_bison_parser googlesql_analyzer_resolver_googlesql_bison_parser
#define re2 googlesql_analyzer_resolver_re2
#define AbslInternalSleepFor googlesql_analyzer_resolver_AbslInternalSleepFor
#define AbslInternalReportFatalUsageError googlesql_analyzer_resolver_AbslInternalReportFatalUsageError
#define AbslInternalMutexYield googlesql_analyzer_resolver_AbslInternalMutexYield
#define AbslInternalPerThreadSemPost googlesql_analyzer_resolver_AbslInternalPerThreadSemPost
#define AbslInternalPerThreadSemWait googlesql_analyzer_resolver_AbslInternalPerThreadSemWait
#define AbslContainerInternalSampleEverything googlesql_analyzer_resolver_AbslContainerInternalSampleEverything
#define AbslInternalSpinLockDelay googlesql_analyzer_resolver_AbslInternalSpinLockDelay
#define AbslInternalSpinLockWake googlesql_analyzer_resolver_AbslInternalSpinLockWake
#define AbslInternalAnnotateIgnoreReadsBegin googlesql_analyzer_resolver_AbslInternalAnnotateIgnoreReadsBegin
#define AbslInternalAnnotateIgnoreReadsEnd googlesql_analyzer_resolver_AbslInternalAnnotateIgnoreReadsEnd
#define AbslInternalGetFileMappingHint googlesql_analyzer_resolver_AbslInternalGetFileMappingHint
#define GoogleSqlalloc googlesql_analyzer_resolver_GoogleSqlalloc
#define GoogleSqlfree googlesql_analyzer_resolver_GoogleSqlfree
#define GoogleSqlrealloc googlesql_analyzer_resolver_GoogleSqlrealloc
#define FLAGS_nooutput_asc_explicitly googlesql_analyzer_resolver_FLAGS_nooutput_asc_explicitly
#define FLAGS_nogooglesql_use_customized_flex_istream googlesql_analyzer_resolver_FLAGS_nogooglesql_use_customized_flex_istream
#define FLAGS_output_asc_explicitly googlesql_analyzer_resolver_FLAGS_output_asc_explicitly
#define FLAGS_googlesql_use_customized_flex_istream googlesql_analyzer_resolver_FLAGS_googlesql_use_customized_flex_istream
#define FLAGS_googlesql_type_factory_nesting_depth_limit googlesql_analyzer_resolver_FLAGS_googlesql_type_factory_nesting_depth_limit
#define FLAGS_googlesql_read_proto_field_optimized_path googlesql_analyzer_resolver_FLAGS_googlesql_read_proto_field_optimized_path
#define FLAGS_googlesql_format_max_output_width googlesql_analyzer_resolver_FLAGS_googlesql_format_max_output_width
#define FLAGS_googlesql_min_length_required_for_edit_distance googlesql_analyzer_resolver_FLAGS_googlesql_min_length_required_for_edit_distance
#define FLAGS_googlesql_simple_iterator_call_time_now_rows_period googlesql_analyzer_resolver_FLAGS_googlesql_simple_iterator_call_time_now_rows_period
#define FLAGS_nogooglesql_type_factory_nesting_depth_limit googlesql_analyzer_resolver_FLAGS_nogooglesql_type_factory_nesting_depth_limit
#define FLAGS_nogooglesql_read_proto_field_optimized_path googlesql_analyzer_resolver_FLAGS_nogooglesql_read_proto_field_optimized_path
#define FLAGS_nogooglesql_format_max_output_width googlesql_analyzer_resolver_FLAGS_nogooglesql_format_max_output_width
#define FLAGS_nogooglesql_min_length_required_for_edit_distance googlesql_analyzer_resolver_FLAGS_nogooglesql_min_length_required_for_edit_distance
#define FLAGS_nogooglesql_simple_iterator_call_time_now_rows_period googlesql_analyzer_resolver_FLAGS_nogooglesql_simple_iterator_call_time_now_rows_period
#define FLAGS_googlesql_enough_stack_bytes googlesql_analyzer_resolver_FLAGS_googlesql_enough_stack_bytes
#define FLAGS_nogooglesql_enough_stack_bytes googlesql_analyzer_resolver_FLAGS_nogooglesql_enough_stack_bytes
#define FLAGS_googlesql_canonicalize_signed_zero_to_string googlesql_analyzer_resolver_FLAGS_googlesql_canonicalize_signed_zero_to_string
#define FLAGS_nogooglesql_canonicalize_signed_zero_to_string googlesql_analyzer_resolver_FLAGS_nogooglesql_canonicalize_signed_zero_to_string
#define FLAGS_googlesql_default_error_message_stability googlesql_analyzer_resolver_FLAGS_googlesql_default_error_message_stability
#define FLAGS_nogooglesql_default_error_message_stability googlesql_analyzer_resolver_FLAGS_nogooglesql_default_error_message_stability
#define FLAGS_googlesql_redact_error_messages_for_tests googlesql_analyzer_resolver_FLAGS_googlesql_redact_error_messages_for_tests
#define FLAGS_nogooglesql_redact_error_messages_for_tests googlesql_analyzer_resolver_FLAGS_nogooglesql_redact_error_messages_for_tests
#define GoogleSqlFlexTokenizerBase googlesql_analyzer_resolver_GoogleSqlFlexTokenizerBase
#define GoogleSqlFlexLexer googlesql_analyzer_resolver_GoogleSqlFlexLexer
#define UCaseMap googlesql_analyzer_resolver_UCaseMap
...
#include "go-zetasql/analyzer/constant_resolver_helper/export.inc"
...
#include "go-zetasql/analyzer/resolver_util/export.inc"
...
#include "go-zetasql/common/constant_utils/export.inc"
...
#include "go-zetasql/common/reflection_helper/export.inc"
#include "go-zetasql/common/status_payload_utils/export.inc"
#include "go-zetasql/common/thread_stack/export.inc"
#include "go-zetasql/common/type_and_argument_kind_visitor/export.inc"
...
#include "go-zetasql/proto/internal_fix_suggestion_cc_proto/export.inc"
...
#endif /* googlesql_analyzer_resolver_bind_cc */
