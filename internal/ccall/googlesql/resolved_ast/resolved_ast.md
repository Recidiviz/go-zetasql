<!--
  resolved_ast.md generated from template:
    https://github.com/google/googlesql/blob/master/zetasql/resolved_ast/resolved_ast.md.template
...
[https://github.com/google/googlesql/blob/master/zetasql/resolved_ast/gen_resolved_ast.py] for both C++
...
[https://github.com/google/googlesql/blob/master/zetasql/resolved_ast/resolved_node.h](https://github.com/google/googlesql/blob/master/zetasql/resolved_ast/resolved_node.h)

The generated classes are specified in
[https://github.com/google/googlesql/blob/master/zetasql/resolved_ast/gen_resolved_ast.py](https://github.com/google/googlesql/blob/master/zetasql/resolved_ast/gen_resolved_ast.py)
See that file for comments on specific nodes and fields.

Additional non-generated classes that are documented separately:

- <a id="ResolvedColumn"></a>[ResolvedColumn](https://github.com/google/googlesql/blob/master/zetasql/resolved_ast/resolved_column.h)
- <a id="ResolvedCollation"></a>[ResolvedCollation](https://github.com/google/googlesql/blob/master/zetasql/resolved_ast/resolved_collation.h)
...
### ResolvedCatalogColumnRef{ #ResolvedCatalogColumnRef }
...
<p><pre><code class="lang-c++"><font color="brown">// A list of ResolvedColumnRef expression references that will be batched
...
<p><pre><code class="lang-c++"><font color="brown">// Describes a leaf extended cast of ResolvedExtendedCast. See the comment
...
<p><pre><code class="lang-c++"><font color="brown">// One field assignment in a ResolvedMakeProto expression.
...
<p><pre><code class="lang-c++"><font color="brown">// Argument for a child of ResolvedFlatten. This is a placeholder to indicate
...
### ResolvedGetProtoOneof{ #ResolvedGetProtoOneof }
...
<p><pre><code class="lang-c++"><font color="brown">// ResolvedWithExpr introduces one or more columns in &lt;assignment_list&gt; that
...
### ResolvedExecuteAsRoleScan{ #ResolvedExecuteAsRoleScan }
...
<p><pre><code class="lang-c++"><font color="brown">// This wrapper is used for an optional ResolvedColumn inside another node.</font>
...
<p><pre><code class="lang-c++"><font color="brown">// List of ResolvedGroupingSetMultiColumn that forms a rollup.
//
...
<p><pre><code class="lang-c++"><font color="brown">// List of ResolvedGroupingSetMultiColumn that forms a cube in grouping sets.
//
...
### ResolvedDifferentialPrivacyAggregateScan{ #ResolvedDifferentialPrivacyAggregateScan }
...
### ResolvedAggregationThresholdAggregateScan{ #ResolvedAggregationThresholdAggregateScan }
...
<p><pre><code class="lang-c++"><font color="brown">// This is one input item in a ResolvedSetOperation.
...
<p><pre><code class="lang-c++"><font color="brown">// Apply a LIMIT and optional OFFSET to the rows from input_scan. Emit all
...
### ResolvedComputedColumnBase{ #ResolvedComputedColumnBase }
...
### ResolvedComputedColumnImpl{ #ResolvedComputedColumnImpl }
...
<p><pre><code class="lang-c++"><font color="brown">// This is the usual ResolvedComputedColumn without deferred side effects.
...
### ResolvedDeferredComputedColumn{ #ResolvedDeferredComputedColumn }

<p><pre><code class="lang-c++"><font color="brown">// This is a ResolvedColumnColumn variant that adds deferred side effect
// capture.
//
...
<p><pre><code class="lang-c++"><font color="brown">// This is used in ResolvedQueryStmt (and other places) to provide a
// user-visible name for each output column, and to map from
// physical ResolvedColumns to user-visible output columns.</font>
...
// Ideally, all those cases could be migrated to use ResolvedOutputSchema.</font>
...
<p><pre><code class="lang-c++"><font color="brown">// ResolvedGroupRowsScan represents a call to a special TVF GROUP_ROWS().
...
### ResolvedGeneralizedQueryStmt{ #ResolvedGeneralizedQueryStmt }
...
### ResolvedCreateSchemaStmtBase{ #ResolvedCreateSchemaStmtBase }
...
### ResolvedCreateExternalSchemaStmt{ #ResolvedCreateExternalSchemaStmt }
...
### ResolvedCreateModelAliasedQuery{ #ResolvedCreateModelAliasedQuery }
...
<font color="brown">  // `query` is present when this node is used as a statement.
  // `query` is not present when used in ResolvedPipeExportDataScan.</font>
  const <a href="#ResolvedScan">ResolvedScan</a>* query() const;
};
</code></pre></p>
...
### ResolvedRecursionDepthModifier{ #ResolvedRecursionDepthModifier }
...
### ResolvedOnConflictClause{ #ResolvedOnConflictClause }
...
<p><pre><code class="lang-c++"><font color="brown">// For an array element modification, this node represents the offset
...
<p><pre><code class="lang-c++"><font color="brown">// This is used by ResolvedMergeStmt to represent one WHEN ... THEN clause
...
### ResolvedAlterExternalSchemaStmt{ #ResolvedAlterExternalSchemaStmt }
...
### ResolvedAlterColumnDropGeneratedAction{ #ResolvedAlterColumnDropGeneratedAction }
...
<font color="brown">  // The new annotations for the column including the new collation
  ...
  // allowed.</font>
  const <a href="#ResolvedColumnAnnotations">ResolvedColumnAnnotations</a>* updated_annotations() const;
};
</code></pre></p>
...
<font color="brown">  // The columns from &lt;input_scan&gt; that are not unpivoted in UNPIVOT
  ...
  // ResolvedColumnRef that references a column from &lt;input_scan&gt;.</font>
...
### ResolvedMatchRecognizeScan{ #ResolvedMatchRecognizeScan }
...
### ResolvedMeasureGroup{ #ResolvedMeasureGroup }

<p><pre><code class="lang-c++"><font color="brown">// Must be contained directly in a ResolvedMatchRecognizeScan. Groups all
...
// match. There can only be one such group in the ResolvedMatchRecognizeScan.</font>
...
<font color="brown">  // Nullptr for the universal group, or name of the referenced pattern
  ...
  // ResolvedMatchRecognizeScan.</font>
...
### ResolvedMatchRecognizeVariableDefinition{ #ResolvedMatchRecognizeVariableDefinition }

<p><pre><code class="lang-c++"><font color="brown">// Represents a row pattern variable definition.
// This node can only be used under ResolvedMatchRecognizeScan.</font>
...
### ResolvedMatchRecognizePatternExpr{ #ResolvedMatchRecognizePatternExpr }
...
### ResolvedMatchRecognizePatternEmpty{ #ResolvedMatchRecognizePatternEmpty }
...
### ResolvedMatchRecognizePatternAnchor{ #ResolvedMatchRecognizePatternAnchor }
...
### ResolvedMatchRecognizePatternVariableRef{ #ResolvedMatchRecognizePatternVariableRef }
...
### ResolvedMatchRecognizePatternOperation{ #ResolvedMatchRecognizePatternOperation }
...
### ResolvedMatchRecognizePatternQuantification{ #ResolvedMatchRecognizePatternQuantification }
...
### ResolvedAuxLoadDataPartitionFilter{ #ResolvedAuxLoadDataPartitionFilter }
...
// &lt;from_files_option_list&gt; the options list describing the source file(s).</font>
...
### ResolvedCreatePropertyGraphStmt{ #ResolvedCreatePropertyGraphStmt }
...
### ResolvedGraphElementTable{ #ResolvedGraphElementTable }
...
<font color="brown">  // ResolvedScan of the underlying table, view etc for column
...
### ResolvedGraphNodeTableReference{ #ResolvedGraphNodeTableReference }
...
### ResolvedGraphElementLabel{ #ResolvedGraphElementLabel }
...
### ResolvedGraphPropertyDeclaration{ #ResolvedGraphPropertyDeclaration }
...
### ResolvedGraphPropertyDefinition{ #ResolvedGraphPropertyDefinition }
...
### ResolvedGraphScanBase{ #ResolvedGraphScanBase }
...
### ResolvedGraphRefScan{ #ResolvedGraphRefScan }
...
### ResolvedGraphLinearScan{ #ResolvedGraphLinearScan }
...
### ResolvedGraphTableScan{ #ResolvedGraphTableScan }
...
### ResolvedGraphScan{ #ResolvedGraphScan }
...
### ResolvedGraphPathPatternQuantifier{ #ResolvedGraphPathPatternQuantifier }
...
### ResolvedGraphPathSearchPrefix{ #ResolvedGraphPathSearchPrefix }
...
### ResolvedGraphPathScanBase{ #ResolvedGraphPathScanBase }
...
### ResolvedGraphElementScan{ #ResolvedGraphElementScan }
...
### ResolvedGraphNodeScan{ #ResolvedGraphNodeScan }

<p><pre><code class="lang-c++"><font color="brown">// A ResolvedGraphElementScan produced by &lt;node pattern&gt;, whose the single
...
### ResolvedGraphEdgeScan{ #ResolvedGraphEdgeScan }

<p><pre><code class="lang-c++"><font color="brown">// A ResolvedGraphElementScan produced by &lt;edge pattern&gt;, whose the single
...
### ResolvedGraphGetElementProperty{ #ResolvedGraphGetElementProperty }
...
### ResolvedGraphLabelExpr{ #ResolvedGraphLabelExpr }
...
### ResolvedGraphLabelNaryExpr{ #ResolvedGraphLabelNaryExpr }
...
### ResolvedGraphLabel{ #ResolvedGraphLabel }
...
### ResolvedGraphWildCardLabel{ #ResolvedGraphWildCardLabel }
...
### ResolvedGraphElementIdentifier{ #ResolvedGraphElementIdentifier }
...
### ResolvedGraphElementProperty{ #ResolvedGraphElementProperty }
...
### ResolvedGraphMakeElement{ #ResolvedGraphMakeElement }
...
### ResolvedArrayAggregate{ #ResolvedArrayAggregate }
...
### ResolvedGraphMakeArrayVariable{ #ResolvedGraphMakeArrayVariable }

<p><pre><code class="lang-c++"><font color="brown">// ResolvedGraphMakeArrayVariable populates the newly created &lt;array&gt;
...
### ResolvedGraphPathMode{ #ResolvedGraphPathMode }
...
### ResolvedGraphPathScan{ #ResolvedGraphPathScan }

<p><pre><code class="lang-c++"><font color="brown">// ResolvedGraphPathScan represents a scan of matching sequences of
...
### ResolvedGraphIsLabeledPredicate{ #ResolvedGraphIsLabeledPredicate }
...
### ResolvedUndropStmt{ #ResolvedUndropStmt }
...
### ResolvedIdentityColumnInfo{ #ResolvedIdentityColumnInfo }
...
### ResolvedLogScan{ #ResolvedLogScan }
...
### ResolvedPipeIfScan{ #ResolvedPipeIfScan }
...
### ResolvedPipeIfCase{ #ResolvedPipeIfCase }

<p><pre><code class="lang-c++"><font color="brown">// This represents one case in a ResolvedPipeIf.
//
...
### ResolvedPipeForkScan{ #ResolvedPipeForkScan }
...
### ResolvedPipeExportDataScan{ #ResolvedPipeExportDataScan }
...
### ResolvedSubpipeline{ #ResolvedSubpipeline }
...
### ResolvedSubpipelineInputScan{ #ResolvedSubpipelineInputScan }

<p><pre><code class="lang-c++"><font color="brown">// This is the scan inside a ResolvedSubpipeline representing the initial
...
### ResolvedGeneralizedQuerySubpipeline{ #ResolvedGeneralizedQuerySubpipeline }
...
<p><pre><code class="lang-c++"><font color="brown">// ResolvedBarrierScan marks an optimization barrier during query planning.
...
### ResolvedLockMode{ #ResolvedLockMode }

<p><pre><code class="lang-c++"><font color="brown">// ResolvedLockMode optionally indicates whether locks should be
