...
#ifndef GOOGLESQL_ANALYZER_REWRITERS_TERNARY_FUNCTION_REWRITER_H_
#define GOOGLESQL_ANALYZER_REWRITERS_TERNARY_FUNCTION_REWRITER_H_
...
#endif  // GOOGLESQL_ANALYZER_REWRITERS_TERNARY_FUNCTION_REWRITER_H_
