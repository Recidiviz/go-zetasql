...
#ifndef GOOGLE_PROTOBUF_INCLUDED_googlesql_2fpublic_2ferror_5flocation_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_googlesql_2fpublic_2ferror_5flocation_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::googlesql::ErrorLocation* Arena::CreateMaybeMessage<::googlesql::ErrorLocation>(Arena*);
template <>
::googlesql::ErrorSource* Arena::CreateMaybeMessage<::googlesql::ErrorSource>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class ErrorLocation final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:googlesql.ErrorLocation) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "googlesql.ErrorLocation";
  }
  protected:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::googlesql::ErrorSource >*
      mutable_error_source();
  private:
  const ::googlesql::ErrorSource& _internal_error_source(int index) const;
  ::googlesql::ErrorSource* _internal_add_error_source();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::googlesql::ErrorSource>& _internal_error_source() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::googlesql::ErrorSource>* _internal_mutable_error_source();
  public:
  const ::googlesql::ErrorSource& error_source(int index) const;
  ::googlesql::ErrorSource* add_error_source();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::googlesql::ErrorSource >&
      error_source() const;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::googlesql::ErrorSource > error_source_;
...
class ErrorSource final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:googlesql.ErrorSource) */ {
 public:
  ...
  void set_allocated_error_message_caret_string(std::string* ptr);
  ...
  void set_allocated_error_location(::googlesql::ErrorLocation* error_location);
  private:
  ...
  void unsafe_arena_set_allocated_error_location(
      ::googlesql::ErrorLocation* error_location);
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::googlesql::ErrorSource >*
...
inline const ::googlesql::ErrorSource& ErrorLocation::_internal_error_source(int index) const {
...
inline ::googlesql::ErrorSource* ErrorLocation::_internal_add_error_source() {
  return _internal_mutable_error_source()->Add();
}
inline ::googlesql::ErrorSource* ErrorLocation::add_error_source() {
  ::googlesql::ErrorSource* _add = _internal_add_error_source();
  // @@protoc_insertion_point(field_add:googlesql.ErrorLocation.error_source)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::googlesql::ErrorSource >&
...
inline PROTOBUF_ALWAYS_INLINE void ErrorSource::set_error_message_caret_string(Arg_&& arg,
                                                     Args_... args) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.error_message_caret_string_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void ErrorSource::set_allocated_error_message_caret_string(std::string* value) {
  ...
  _impl_.error_message_caret_string_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline const ::googlesql::ErrorLocation& ErrorSource::error_location() const {
...
inline ::googlesql::ErrorLocation* ErrorSource::mutable_error_location() {
...
inline void ErrorSource::set_allocated_error_location(::googlesql::ErrorLocation* error_location) {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_googlesql_2fpublic_2ferror_5flocation_2eproto_2epb_2eh
