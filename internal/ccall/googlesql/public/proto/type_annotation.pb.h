...
#ifndef GOOGLE_PROTOBUF_INCLUDED_googlesql_2fpublic_2fproto_2ftype_5fannotation_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_googlesql_2fpublic_2fproto_2ftype_5fannotation_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::googlesql::DeprecatedEncoding* Arena::CreateMaybeMessage<::googlesql::DeprecatedEncoding>(Arena*);
template <>
::googlesql::FieldFormat* Arena::CreateMaybeMessage<::googlesql::FieldFormat>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& DeprecatedEncoding_Encoding_Name(DeprecatedEncoding_Encoding value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<DeprecatedEncoding_Encoding_descriptor,
                                                 -1, 1>(
      static_cast<int>(value));
}
...
class FieldFormat final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:googlesql.FieldFormat) */ {
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Format_descriptor() {
...
class DeprecatedEncoding final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:googlesql.DeprecatedEncoding) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "googlesql.DeprecatedEncoding";
  }
  protected:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Encoding_descriptor() {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_googlesql_2fpublic_2fproto_2ftype_5fannotation_2eproto_2epb_2eh
