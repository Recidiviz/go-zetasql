...
using Location = ::googlesql::ParseLocationRange;
  explicit TmScanLexer(absl::string_view input_source ABSL_ATTRIBUTE_LIFETIME_BOUND);
...
inline std::ostream& operator<<(std::ostream& os, const TmScanLexer& lexer) {
  return os << "googlesql::parser::TmScanLexer at line " << lexer.LastTokenLine() << " location "
