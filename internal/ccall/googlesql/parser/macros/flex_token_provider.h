...
#ifndef GOOGLESQL_PARSER_MACROS_FLEX_TOKEN_PROVIDER_H_
#define GOOGLESQL_PARSER_MACROS_FLEX_TOKEN_PROVIDER_H_
...
#endif  // GOOGLESQL_PARSER_MACROS_FLEX_TOKEN_PROVIDER_H_
