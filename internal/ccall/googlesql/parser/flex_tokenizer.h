...
#ifndef GOOGLESQL_PARSER_FLEX_TOKENIZER_H_
#define GOOGLESQL_PARSER_FLEX_TOKENIZER_H_
...
// The legacy Flex-based tokenizer for GoogleSQL. Kept only for validation
// purpose.
class LegacyFlexTokenizer final : public GoogleSqlFlexTokenizerBase {
 public:
...
using GoogleSqlFlexTokenizer ABSL_DEPRECATED("Inline me!") = GoogleSqlTokenizer;
