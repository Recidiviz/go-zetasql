...
#if !defined(GOOGLESQL_FLEX_TOKENIZER_FLAGS_SKIP_DEFINITION)
...
#else
ABSL_DECLARE_FLAG(bool, googlesql_use_customized_flex_istream);
...
#endif  // !GOOGLESQL_FLEX_TOKENIZER_FLAGS_SKIP_DEFINITION
...
absl::Status GoogleSqlTokenizer::ValidateTextMapperToken(
...
constexpr absl::string_view kTokenOutOfSyncError =
    ...
    "the lexer rule in flex_tokenizer.l or googlesql.tm?";
