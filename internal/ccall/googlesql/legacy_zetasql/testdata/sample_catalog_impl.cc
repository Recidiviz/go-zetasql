...
#include "googlesql/legacy_zetasql/common/internal_property_graph.h"
...
#include "googlesql/legacy_zetasql/public/measure_expression.h"
...
#include "googlesql/legacy_zetasql/testdata/ambiguous_has.pb.h"
...
CatalogRegistry() {
  static zetasql_base::NoDestructor<
      std::vector<absl::FunctionRef<void(zetasql::SimpleCatalog * catalog)>>>
      registry;
  return *registry;
}
