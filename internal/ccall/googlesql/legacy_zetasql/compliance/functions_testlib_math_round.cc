...
std::vector<FunctionTestCall> GetFunctionTestsRounding() {
  ...
  std::vector<FunctionTestCall> all_tests = {
      ...
      {"round", {float_pos_inf, -1000ll}, float_pos_inf},
      {"round", {float_pos_inf, 1000ll}, float_pos_inf},
      {"round", {float_neg_inf, 0ll}, float_neg_inf},
      {"round", {float_neg_inf, -1000ll}, float_neg_inf},
      {"round", {float_neg_inf, 1000ll}, float_neg_inf},
      {"round", {float_nan, 0ll}, float_nan},
      {"round", {float_nan, 1000ll}, float_nan},
      {"round", {float_nan, -1000ll}, float_nan},
      ...
      {"round", {double_pos_inf, -1000ll}, double_pos_inf},
      {"round", {double_pos_inf, 1000ll}, double_pos_inf},
      {"round", {double_neg_inf, 0ll}, double_neg_inf},
      {"round", {double_neg_inf, -1000ll}, double_neg_inf},
      {"round", {double_neg_inf, 1000ll}, double_neg_inf},
      ...
      {"trunc", {float_pos_inf, -1000ll}, float_pos_inf},
      {"trunc", {float_pos_inf, 1000ll}, float_pos_inf},
      {"trunc", {float_neg_inf, 0ll}, float_neg_inf},
      {"trunc", {float_neg_inf, 1000ll}, float_neg_inf},
      {"trunc", {float_neg_inf, -1000ll}, float_neg_inf},
      {"trunc", {float_nan, 0ll}, float_nan},
      {"trunc", {float_nan, 1000ll}, float_nan},
      {"trunc", {float_nan, -1000ll}, float_nan},
      ...
      {"trunc", {double_pos_inf, -1000ll}, double_pos_inf},
      {"trunc", {double_pos_inf, 1000ll}, double_pos_inf},
      {"trunc", {double_neg_inf, 0ll}, double_neg_inf},
      {"trunc", {double_neg_inf, -1000ll}, double_neg_inf},
      {"trunc", {double_neg_inf, 1000ll}, double_neg_inf},
