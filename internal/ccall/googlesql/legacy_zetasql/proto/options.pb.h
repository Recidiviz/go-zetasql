...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fproto_2foptions_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fproto_2foptions_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::zetasql::AllowedHintsAndOptionsProto* Arena::CreateMaybeMessage<::zetasql::AllowedHintsAndOptionsProto>(Arena*);
template <>
::zetasql::AllowedHintsAndOptionsProto_HintProto* Arena::CreateMaybeMessage<::zetasql::AllowedHintsAndOptionsProto_HintProto>(Arena*);
template <>
::zetasql::AllowedHintsAndOptionsProto_OptionProto* Arena::CreateMaybeMessage<::zetasql::AllowedHintsAndOptionsProto_OptionProto>(Arena*);
template <>
::zetasql::AnalyzerOptionsProto* Arena::CreateMaybeMessage<::zetasql::AnalyzerOptionsProto>(Arena*);
template <>
::zetasql::AnalyzerOptionsProto_QueryParameterProto* Arena::CreateMaybeMessage<::zetasql::AnalyzerOptionsProto_QueryParameterProto>(Arena*);
template <>
::zetasql::AnalyzerOptionsProto_SystemVariableProto* Arena::CreateMaybeMessage<::zetasql::AnalyzerOptionsProto_SystemVariableProto>(Arena*);
template <>
::zetasql::EnabledRewriteProto* Arena::CreateMaybeMessage<::zetasql::EnabledRewriteProto>(Arena*);
template <>
::zetasql::LanguageOptionsProto* Arena::CreateMaybeMessage<::zetasql::LanguageOptionsProto>(Arena*);
template <>
::zetasql::ZetaSQLBuiltinFunctionOptionsProto* Arena::CreateMaybeMessage<::zetasql::ZetaSQLBuiltinFunctionOptionsProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class ZetaSQLBuiltinFunctionOptionsProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::EnabledRewriteProto>& _internal_enabled_rewrites_map_entry() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::EnabledRewriteProto>* _internal_mutable_enabled_rewrites_map_entry();
  public:
...
class AllowedHintsAndOptionsProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AllowedHintsAndOptionsProto_HintProto>& _internal_hint() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AllowedHintsAndOptionsProto_HintProto>* _internal_mutable_hint();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AllowedHintsAndOptionsProto_OptionProto>& _internal_option() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AllowedHintsAndOptionsProto_OptionProto>* _internal_mutable_option();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AllowedHintsAndOptionsProto_OptionProto>& _internal_anonymization_option() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AllowedHintsAndOptionsProto_OptionProto>* _internal_mutable_anonymization_option();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AllowedHintsAndOptionsProto_OptionProto>& _internal_differential_privacy_option() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AllowedHintsAndOptionsProto_OptionProto>* _internal_mutable_differential_privacy_option();
  public:
...
class AnalyzerOptionsProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnalyzerOptionsProto_QueryParameterProto>& _internal_query_parameters() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnalyzerOptionsProto_QueryParameterProto>* _internal_mutable_query_parameters();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnalyzerOptionsProto_QueryParameterProto>& _internal_expression_columns() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnalyzerOptionsProto_QueryParameterProto>* _internal_mutable_expression_columns();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::TypeProto>& _internal_positional_query_parameters() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::TypeProto>* _internal_mutable_positional_query_parameters();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnalyzerOptionsProto_QueryParameterProto>& _internal_ddl_pseudo_columns() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnalyzerOptionsProto_QueryParameterProto>* _internal_mutable_ddl_pseudo_columns();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnalyzerOptionsProto_SystemVariableProto>& _internal_system_variables() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnalyzerOptionsProto_SystemVariableProto>* _internal_mutable_system_variables();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::TypeProto>& _internal_target_column_types() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::TypeProto>* _internal_mutable_target_column_types();
  public:
  ...
  // optional .zetasql.RewriteOptions rewrite_options = 28;
  bool has_rewrite_options() const;
  void clear_rewrite_options() ;
  const ::zetasql::RewriteOptions& rewrite_options() const;
  PROTOBUF_NODISCARD ::zetasql::RewriteOptions* release_rewrite_options();
  ::zetasql::RewriteOptions* mutable_rewrite_options();
  void set_allocated_rewrite_options(::zetasql::RewriteOptions* rewrite_options);
  private:
  const ::zetasql::RewriteOptions& _internal_rewrite_options() const;
  ::zetasql::RewriteOptions* _internal_mutable_rewrite_options();
  public:
  void unsafe_arena_set_allocated_rewrite_options(
      ::zetasql::RewriteOptions* rewrite_options);
  ::zetasql::RewriteOptions* unsafe_arena_release_rewrite_options();
  ...
  bool has_show_function_signature_mismatch_details() const;
  void clear_show_function_signature_mismatch_details() ;
  bool show_function_signature_mismatch_details() const;
  void set_show_function_signature_mismatch_details(bool value);

  private:
  bool _internal_show_function_signature_mismatch_details() const;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::zetasql::RewriteOptions* rewrite_options_;
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>& ZetaSQLBuiltinFunctionOptionsProto::include_function_ids() const {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* ZetaSQLBuiltinFunctionOptionsProto::mutable_include_function_ids() {
...
inline ::zetasql::FunctionSignatureId ZetaSQLBuiltinFunctionOptionsProto::_internal_include_function_ids(int index) const {
  return static_cast<::zetasql::FunctionSignatureId>(_internal_include_function_ids().Get(index));
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>& ZetaSQLBuiltinFunctionOptionsProto::_internal_include_function_ids() const {
  return _impl_.include_function_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* ZetaSQLBuiltinFunctionOptionsProto::_internal_mutable_include_function_ids() {
  return &_impl_.include_function_ids_;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>& ZetaSQLBuiltinFunctionOptionsProto::exclude_function_ids() const {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* ZetaSQLBuiltinFunctionOptionsProto::mutable_exclude_function_ids() {
...
inline ::zetasql::FunctionSignatureId ZetaSQLBuiltinFunctionOptionsProto::_internal_exclude_function_ids(int index) const {
  return static_cast<::zetasql::FunctionSignatureId>(_internal_exclude_function_ids().Get(index));
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>& ZetaSQLBuiltinFunctionOptionsProto::_internal_exclude_function_ids() const {
  return _impl_.exclude_function_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* ZetaSQLBuiltinFunctionOptionsProto::_internal_mutable_exclude_function_ids() {
  return &_impl_.exclude_function_ids_;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::EnabledRewriteProto>&
ZetaSQLBuiltinFunctionOptionsProto::_internal_enabled_rewrites_map_entry() const {
  return _impl_.enabled_rewrites_map_entry_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::EnabledRewriteProto>*
ZetaSQLBuiltinFunctionOptionsProto::_internal_mutable_enabled_rewrites_map_entry() {
  return &_impl_.enabled_rewrites_map_entry_;
}
...
inline ::zetasql::FunctionSignatureId EnabledRewriteProto::_internal_key() const {
  return static_cast<::zetasql::FunctionSignatureId>(_impl_.key_);
}
...
inline ::zetasql::LanguageFeature LanguageOptionsProto::_internal_enabled_language_features(int index) const {
  return static_cast<::zetasql::LanguageFeature>(_internal_enabled_language_features().Get(index));
}
...
inline ::zetasql::ResolvedNodeKind LanguageOptionsProto::_internal_supported_statement_kinds(int index) const {
  return static_cast<::zetasql::ResolvedNodeKind>(_internal_supported_statement_kinds().Get(index));
}
...
inline void LanguageOptionsProto::set_supported_generic_entity_types(int index, absl::string_view value) {
  _internal_mutable_supported_generic_entity_types()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:zetasql.LanguageOptionsProto.supported_generic_entity_types)
}
...
inline void LanguageOptionsProto::add_supported_generic_entity_types(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:zetasql.LanguageOptionsProto.supported_generic_entity_types)
}
...
inline void LanguageOptionsProto::set_reserved_keywords(int index, absl::string_view value) {
  _internal_mutable_reserved_keywords()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:zetasql.LanguageOptionsProto.reserved_keywords)
}
...
inline void LanguageOptionsProto::add_reserved_keywords(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:zetasql.LanguageOptionsProto.reserved_keywords)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
...
inline void LanguageOptionsProto::set_supported_generic_sub_entity_types(int index, absl::string_view value) {
  _internal_mutable_supported_generic_sub_entity_types()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:zetasql.LanguageOptionsProto.supported_generic_sub_entity_types)
}
...
inline void LanguageOptionsProto::add_supported_generic_sub_entity_types(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:zetasql.LanguageOptionsProto.supported_generic_sub_entity_types)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
...
inline ::zetasql::AllowedHintsAndOptionsProto_OptionProto_ResolvingKind AllowedHintsAndOptionsProto_OptionProto::_internal_resolving_kind() const {
  return static_cast<::zetasql::AllowedHintsAndOptionsProto_OptionProto_ResolvingKind>(_impl_.resolving_kind_);
}
...
inline void AllowedHintsAndOptionsProto::set_disallow_unknown_hints_with_qualifier(int index, absl::string_view value) {
  _internal_mutable_disallow_unknown_hints_with_qualifier()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:zetasql.AllowedHintsAndOptionsProto.disallow_unknown_hints_with_qualifier)
}
...
inline void AllowedHintsAndOptionsProto::add_disallow_unknown_hints_with_qualifier(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:zetasql.AllowedHintsAndOptionsProto.disallow_unknown_hints_with_qualifier)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
...
inline bool AllowedHintsAndOptionsProto::disallow_duplicate_option_names() const {
  // @@protoc_insertion_point(field_get:zetasql.AllowedHintsAndOptionsProto.disallow_duplicate_option_names)
...
inline void AllowedHintsAndOptionsProto::set_disallow_duplicate_option_names(bool value) {
  ...
  // @@protoc_insertion_point(field_set:zetasql.AllowedHintsAndOptionsProto.disallow_duplicate_option_names)
}
...
inline void AnalyzerOptionsProto_SystemVariableProto::set_name_path(int index, absl::string_view value) {
  _internal_mutable_name_path()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:zetasql.AnalyzerOptionsProto.SystemVariableProto.name_path)
}
...
inline void AnalyzerOptionsProto_SystemVariableProto::add_name_path(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:zetasql.AnalyzerOptionsProto.SystemVariableProto.name_path)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
...
inline ::zetasql::ResolvedASTRewrite AnalyzerOptionsProto::_internal_enabled_rewrites(int index) const {
  return static_cast<::zetasql::ResolvedASTRewrite>(_internal_enabled_rewrites().Get(index));
}
...
// optional bool show_function_signature_mismatch_details = 27;
inline bool AnalyzerOptionsProto::has_show_function_signature_mismatch_details() const {
  bool value = (_impl_._has_bits_[0] & 0x00008000u) != 0;
  return value;
}
inline void AnalyzerOptionsProto::clear_show_function_signature_mismatch_details() {
  _impl_.show_function_signature_mismatch_details_ = false;
  _impl_._has_bits_[0] &= ~0x00008000u;
}
inline bool AnalyzerOptionsProto::show_function_signature_mismatch_details() const {
  // @@protoc_insertion_point(field_get:zetasql.AnalyzerOptionsProto.show_function_signature_mismatch_details)
  return _internal_show_function_signature_mismatch_details();
}
inline void AnalyzerOptionsProto::set_show_function_signature_mismatch_details(bool value) {
  _internal_set_show_function_signature_mismatch_details(value);
  // @@protoc_insertion_point(field_set:zetasql.AnalyzerOptionsProto.show_function_signature_mismatch_details)
}
inline bool AnalyzerOptionsProto::_internal_show_function_signature_mismatch_details() const {
  return _impl_.show_function_signature_mismatch_details_;
}
inline void AnalyzerOptionsProto::_internal_set_show_function_signature_mismatch_details(bool value) {
  _impl_._has_bits_[0] |= 0x00008000u;
  _impl_.show_function_signature_mismatch_details_ = value;
}
...
inline const ::zetasql::RewriteOptions& AnalyzerOptionsProto::_internal_rewrite_options() const {
  const ::zetasql::RewriteOptions* p = _impl_.rewrite_options_;
  return p != nullptr ? *p : reinterpret_cast<const ::zetasql::RewriteOptions&>(
      ::zetasql::_RewriteOptions_default_instance_);
}
inline const ::zetasql::RewriteOptions& AnalyzerOptionsProto::rewrite_options() const {
  // @@protoc_insertion_point(field_get:zetasql.AnalyzerOptionsProto.rewrite_options)
...
inline void AnalyzerOptionsProto::unsafe_arena_set_allocated_rewrite_options(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:zetasql.AnalyzerOptionsProto.rewrite_options)
}
inline ::zetasql::RewriteOptions* AnalyzerOptionsProto::release_rewrite_options() {
  _impl_._has_bits_[0] &= ~0x00000020u;
  ::zetasql::RewriteOptions* temp = _impl_.rewrite_options_;
...
inline ::zetasql::RewriteOptions* AnalyzerOptionsProto::unsafe_arena_release_rewrite_options() {
  // @@protoc_insertion_point(field_release:zetasql.AnalyzerOptionsProto.rewrite_options)
  _impl_._has_bits_[0] &= ~0x00000020u;
  ::zetasql::RewriteOptions* temp = _impl_.rewrite_options_;
  _impl_.rewrite_options_ = nullptr;
  return temp;
}
inline ::zetasql::RewriteOptions* AnalyzerOptionsProto::_internal_mutable_rewrite_options() {
  _impl_._has_bits_[0] |= 0x00000020u;
  if (_impl_.rewrite_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::zetasql::RewriteOptions>(GetArenaForAllocation());
    _impl_.rewrite_options_ = p;
  }
  return _impl_.rewrite_options_;
}
inline ::zetasql::RewriteOptions* AnalyzerOptionsProto::mutable_rewrite_options() {
  ::zetasql::RewriteOptions* _msg = _internal_mutable_rewrite_options();
  // @@protoc_insertion_point(field_mutable:zetasql.AnalyzerOptionsProto.rewrite_options)
  return _msg;
}
inline void AnalyzerOptionsProto::set_allocated_rewrite_options(::zetasql::RewriteOptions* rewrite_options) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.rewrite_options_);
  }
...
template <>
struct is_proto_enum<::zetasql::AllowedHintsAndOptionsProto_OptionProto_ResolvingKind> : std::true_type {};
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_zetasql_2fproto_2foptions_2eproto_2epb_2eh
