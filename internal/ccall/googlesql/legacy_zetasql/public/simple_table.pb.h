...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fsimple_5ftable_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fsimple_5ftable_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::zetasql::ExpressionAttributeProto* Arena::CreateMaybeMessage<::zetasql::ExpressionAttributeProto>(Arena*);
template <>
::zetasql::SimpleAnonymizationInfoProto* Arena::CreateMaybeMessage<::zetasql::SimpleAnonymizationInfoProto>(Arena*);
template <>
::zetasql::SimpleColumnProto* Arena::CreateMaybeMessage<::zetasql::SimpleColumnProto>(Arena*);
template <>
::zetasql::SimpleTableProto* Arena::CreateMaybeMessage<::zetasql::SimpleTableProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
constexpr ExpressionAttributeProto_ExpressionKind ExpressionAttributeProto_ExpressionKind_ExpressionKind_MAX = static_cast<ExpressionAttributeProto_ExpressionKind>(1);
constexpr int ExpressionAttributeProto_ExpressionKind_ExpressionKind_ARRAYSIZE = 1 + 1;
...
class SimpleTableProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::SimpleColumnProto>& _internal_column() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::SimpleColumnProto>* _internal_mutable_column();
  public:
...
class ExpressionAttributeProto final :
 ...
 public:
  ...
  ::zetasql::ExpressionAttributeProto_ExpressionKind expression_kind() const;
  void set_expression_kind(::zetasql::ExpressionAttributeProto_ExpressionKind value);

  private:
  ::zetasql::ExpressionAttributeProto_ExpressionKind _internal_expression_kind() const;
  void _internal_set_expression_kind(::zetasql::ExpressionAttributeProto_ExpressionKind value);
...
inline void SimpleAnonymizationInfoProto::set_userid_column_name(int index, absl::string_view value) {
  _internal_mutable_userid_column_name()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:zetasql.SimpleAnonymizationInfoProto.userid_column_name)
}
...
inline void SimpleAnonymizationInfoProto::add_userid_column_name(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:zetasql.SimpleAnonymizationInfoProto.userid_column_name)
}
...
inline ::zetasql::ExpressionAttributeProto_ExpressionKind ExpressionAttributeProto::expression_kind() const {
  // @@protoc_insertion_point(field_get:zetasql.ExpressionAttributeProto.expression_kind)
  return _internal_expression_kind();
}
inline void ExpressionAttributeProto::set_expression_kind(::zetasql::ExpressionAttributeProto_ExpressionKind value) {
   _internal_set_expression_kind(value);
  // @@protoc_insertion_point(field_set:zetasql.ExpressionAttributeProto.expression_kind)
}
inline ::zetasql::ExpressionAttributeProto_ExpressionKind ExpressionAttributeProto::_internal_expression_kind() const {
  return static_cast<::zetasql::ExpressionAttributeProto_ExpressionKind>(_impl_.expression_kind_);
}
inline void ExpressionAttributeProto::_internal_set_expression_kind(::zetasql::ExpressionAttributeProto_ExpressionKind value) {
  assert(::zetasql::ExpressionAttributeProto_ExpressionKind_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000002u;
...
inline const ::zetasql::ExpressionAttributeProto& SimpleColumnProto::_internal_column_expression() const {
  const ::zetasql::ExpressionAttributeProto* p = _impl_.column_expression_;
...
inline ::zetasql::ExpressionAttributeProto* SimpleColumnProto::release_column_expression() {
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::zetasql::ExpressionAttributeProto* temp = _impl_.column_expression_;
...
template <>
struct is_proto_enum<::zetasql::ExpressionAttributeProto_ExpressionKind> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::zetasql::ExpressionAttributeProto_ExpressionKind>() {
  return ::zetasql::ExpressionAttributeProto_ExpressionKind_descriptor();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fsimple_5ftable_2eproto_2epb_2eh
