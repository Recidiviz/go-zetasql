...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fsimple_5fconstant_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fsimple_5fconstant_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::zetasql::SimpleConstantProto* Arena::CreateMaybeMessage<::zetasql::SimpleConstantProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline void SimpleConstantProto::set_name_path(int index, absl::string_view value) {
  _internal_mutable_name_path()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:zetasql.SimpleConstantProto.name_path)
}
...
inline void SimpleConstantProto::add_name_path(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:zetasql.SimpleConstantProto.name_path)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fsimple_5fconstant_2eproto_2epb_2eh
