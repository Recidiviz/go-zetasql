...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ArrayFindEnums_ArrayFindMode_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_zetasql_2fpublic_2ffunctions_2farray_5ffind_5fmode_2eproto);
  return file_level_enum_descriptors_zetasql_2fpublic_2ffunctions_2farray_5ffind_5fmode_2eproto[0];
}
