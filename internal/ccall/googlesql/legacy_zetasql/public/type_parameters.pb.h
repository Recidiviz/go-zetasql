...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2ftype_5fparameters_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2ftype_5fparameters_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::zetasql::ExtendedTypeParametersProto* Arena::CreateMaybeMessage<::zetasql::ExtendedTypeParametersProto>(Arena*);
template <>
::zetasql::NumericTypeParametersProto* Arena::CreateMaybeMessage<::zetasql::NumericTypeParametersProto>(Arena*);
template <>
::zetasql::StringTypeParametersProto* Arena::CreateMaybeMessage<::zetasql::StringTypeParametersProto>(Arena*);
template <>
::zetasql::TypeParametersProto* Arena::CreateMaybeMessage<::zetasql::TypeParametersProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class TypeParametersProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::TypeParametersProto>& _internal_child_list() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::TypeParametersProto>* _internal_mutable_child_list();
  public:
...
class ExtendedTypeParametersProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::SimpleValueProto>& _internal_parameters() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::SimpleValueProto>* _internal_mutable_parameters();
  public:
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2ftype_5fparameters_2eproto_2epb_2eh
