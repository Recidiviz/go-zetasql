...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fannotation_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fannotation_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::zetasql::AnnotationMapProto* Arena::CreateMaybeMessage<::zetasql::AnnotationMapProto>(Arena*);
template <>
::zetasql::AnnotationProto* Arena::CreateMaybeMessage<::zetasql::AnnotationProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class AnnotationMapProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnnotationProto>& _internal_annotations() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnnotationProto>* _internal_mutable_annotations();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnnotationMapProto>& _internal_struct_fields() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::zetasql::AnnotationMapProto>* _internal_mutable_struct_fields();
  public:
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fannotation_2eproto_2epb_2eh
