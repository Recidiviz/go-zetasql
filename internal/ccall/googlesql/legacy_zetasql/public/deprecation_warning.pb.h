...
constexpr DeprecationWarning_Kind DeprecationWarning_Kind_Kind_MAX = static_cast<DeprecationWarning_Kind>(8);
constexpr int DeprecationWarning_Kind_Kind_ARRAYSIZE = 8 + 1;
