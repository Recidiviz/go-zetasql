...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fscripting_2fvariable_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fscripting_2fvariable_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::zetasql::Variable* Arena::CreateMaybeMessage<::zetasql::Variable>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const ::zetasql::TypeParametersProto& Variable::_internal_type_params() const {
  const ::zetasql::TypeParametersProto* p = _impl_.type_params_;
...
inline ::zetasql::TypeParametersProto* Variable::release_type_params() {
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::zetasql::TypeParametersProto* temp = _impl_.type_params_;
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_zetasql_2fscripting_2fvariable_2eproto_2epb_2eh
