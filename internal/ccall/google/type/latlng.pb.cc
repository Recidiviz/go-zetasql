...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas_google_2ftype_2flatlng_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::google::type::LatLng)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances_google_2ftype_2flatlng_2eproto[] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2ftype_2flatlng_2eproto = {
  false, false, 195, descriptor_table_protodef_google_2ftype_2flatlng_2eproto, "google/type/latlng.proto", 
  &descriptor_table_google_2ftype_2flatlng_2eproto_once, nullptr, 0, 1,
  schemas_google_2ftype_2flatlng_2eproto, file_default_instances_google_2ftype_2flatlng_2eproto, TableStruct_google_2ftype_2flatlng_2eproto::offsets,
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_google_2ftype_2flatlng_2eproto_getter() {
...
void LatLng::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<LatLng *>(to)->MergeFrom(
      static_cast<const LatLng &>(from));
}
