...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas_google_2fprotobuf_2fempty_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::PROTOBUF_NAMESPACE_ID::Empty)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances_google_2fprotobuf_2fempty_2eproto[] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fprotobuf_2fempty_2eproto = {
  ...
  schemas_google_2fprotobuf_2fempty_2eproto, file_default_instances_google_2fprotobuf_2fempty_2eproto, TableStruct_google_2fprotobuf_2fempty_2eproto::offsets,
